...
def generate_shelves_assets(
    stage, shelves_prim_path, shelves_json_path, shelves_asset_path
):
    ...
    for shelf_id, shelf_details in shelves_data.items():
        ...
        shelf_asset_path = (
            shelves_asset_path + shelf_details["asset_path_extension"]
        )
...
def generate_conveyor_assets(
    stage, conveyor_prim_path, conveyor_json_path, conveyor_asset_path
):
    ...
    for conveyor_id, conveyor_details in conveyors_data.items():
        ...
        full_conveyor_asset_path = (
            conveyor_asset_path + conveyor_details["asset_path_extension"]
        )
